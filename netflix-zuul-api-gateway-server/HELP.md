...
* The original package name 'com.in24.zuul.api.gateway.netflix-zuul-api-gateway-server' is invalid and this project uses 'com.in24.zuul.api.gateway.netflixzuulapigatewayserver' instead.
